...
{
    public class FilterProductViewModel: BaseViewModel 
    {
        ...
        private ObservableCollection<TypeViewModel> _types = new ObservableCollection<TypeViewModel>(Settings.Types);
